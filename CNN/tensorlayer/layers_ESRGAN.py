...
class DRRBLayer(Layer):
    def __init__(
        ...
        with tf.variable_scope(name) as vs:
            ...
            dense_conv_5 = Conv2d(dense_conv_5_in, 64, (1, 1), (1, 1), padding='SAME', act=tf.identity, name='dense_conv_5_{}_{}'.format(i,j))
...
class DRRBLayer_Scaling(Layer):
    def __init__(
        ...
        with tf.variable_scope(name) as vs:
            ...
            dense_conv_5_in = ConcatLayer([x, dense_conv_1, dense_conv_2, dense_conv_3, dense_conv_4], concat_dim=3, name='dense_conv_5_in_{}_{}'.format(i,j))
            dense_conv_5 = Conv2d(dense_conv_5_in, 64, (1, 1), (1, 1), padding='SAME', act=tf.identity, name='dense_conv_5_{}_{}'.format(i,j))
            dense_conv_5.outputs = tf.multiply(dense_conv_5.outputs, 0.2)
...
class DRRBLayer_efficient_v2(Layer):
    def __init__(
            self,
            layer1=None,
            layer2=None,
            layer3=None,
            name='DRRB_efficient_v2',
            C_nums=4,
    ):
        Layer.__init__(self, name=name)
        inputs = layer1
        ...
        self.all_layers = list(inputs.all_layers)
        self.all_params = list(inputs.all_params)
        self.all_drop = dict(inputs.all_drop)
        self.all_layers.extend([self.outputs])

class DRRBLayer_efficient(Layer):
    def __init__(
        self,
        layer1=None,
        layer2=None,
